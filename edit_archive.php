...
require ("connection.php");
	...
	if ($result->num_rows > 0) {
		...
		$hrs_explanation = $row['hrs_explanation'];
		...
		<div class="tab-content">
			...
			<div class = "newclienttab-inner" style = "float: left; width 50%; width: 100%">
					<div class='allcontacts-table'><table border='0' cellspacing='0' cellpadding='0' class='table-bordered allcontacts-table'>
							...
							?></select></td><td><label>Records Total</label><input id = "records_total" name="records_total" type="text" class="contact-prefix" style = "width: 50%; margin-right: 40%" value = "<?php echo $records_total ?>"></td></tr>
					</tbody></table></td></tr></tbody></table></div>	
				</div>
			...
			<div class = "newclienttab-inner" style = "float: left; width 50%; width: 35%; margin-left: 17%">
					<div id = "blue_sheet_table" class='allcontacts-table'><table border='0' cellspacing='0' cellpadding='0' class='table-bordered allcontacts-table'>
							...
							<tr><td><label>Data Hours</label></td><td><input id = "data_hrs" name="data_hrs" type="text" class="contact-prefix" value = "<?php echo $data_hrs;?>"></td></tr>
                    ...
                    <table id="W_MTable" border="1" cellpadding="1" cellspacing="1" style='text-align: center; vertical-align: middle;'>
                        ...
                        while($row = $result->fetch_assoc()){
                                echo "<tr id='1'>
										...
										<td>
											<select id = 'location1' name = 'location1'><option value = '' selected = 'selected'>--Choose Location--</option><option value = '29 Front'>29 Front</option><option value = '29 Middle'>29 Middle</option><option value = '29 Back'>29 Back</option><option value = '31 Front'>31 Front</option><option value = '31 Middle'>31 Middle</option><option value = '31 Back'>31 Back</option></select>
										</td>
                                        <td><p onclick = removeWeights_Measures('#1')>X</p></td>
                                    </tr>";
                                    }
                        ?>
                        </tbody>
